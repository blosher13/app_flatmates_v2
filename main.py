...
while True:
    try:
        ...
        bill_f1 = Bill(bill_amount, bill_period).bill()
        bill_f2 = Bill(bill_amount, bill_period).bill()
        amount_f1 = Flatmate(name_f1, days_stayed_f1).pays(bill_f1, days_stayed_f2)
        amount_f2 = Flatmate(name_f2, days_stayed_f2).pays(bill_f2, days_stayed_f1)
